...
public class JEILiquidSlotImpl extends JEISlotImpl implements JEILiquidSlot {
    ...
    public JEILiquidSlotImpl(boolean isInput, int x, int y, int width, int height,
    ...
    public void Render(Minecraft minecraft) {
        if (this.hasBase) {
            JEIExpansion.createFluidElement(this.x, this.y, this.width, this.height).Render(minecraft);
        }
    }
}
